...
func GramineActivate(req *rpc.ActivationReq, coordAddr string, tlsCredentials credentials.TransportCredentials) (*rpc.Parameters, *rpc.DeactivationSettings, error) {
	// call the actual Activate function
	params, deactivationSettings, err := ActivateRPC(req, coordAddr, tlsCredentials)
	if err != nil {
		return nil, nil, err
	}
	...
	return params, deactivationSettings, nil
}
