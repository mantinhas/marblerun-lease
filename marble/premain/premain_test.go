...
func TestPreMain(t *testing.T) {
	...
	activate := func(req *rpc.ActivationReq, coordAddr string, tlsCredentials credentials.TransportCredentials) (*rpc.Parameters, *rpc.DeactivationSettings, error) {
		...
		return parameters, nil, activateError
	}
