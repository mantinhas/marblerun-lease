...
def benchmark(model, nimages, nloops):
    ...
    for i in range(nloops):
        ...
        result["environment_type"] = "marblerun"
    ...
    with open('results/aggregate_results.csv', 'a', newline='') as csvfile:
    ...
    with open("results/model_data.csv", 'a', newline='') as csvfile:
    ...
    with open("results/aggregate_model_data.csv", 'a', newline='') as csvfile:
